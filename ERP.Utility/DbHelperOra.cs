...
namespace ERP.Utility
{
    public class DbHelperOra
    {
        ...
        public static DataSet GetDataSet(string commandText, CommandType commandType, params OracleParameter[] pars)
        {
        ...
        public static int ExecuteCommand(string commandText, CommandType commandType, params OracleParameter[] pars)
        {
            OracleConnection connection = new OracleConnection(Connection);
            OracleCommand cmd = new OracleCommand();
            cmd.Connection = connection;
        ...
        public static int ExecuteSqlTran_paras(ArrayList arr)
        {
            int j = 0;
            using (OracleConnection connection = new OracleConnection(Connection))
            {
